...
import { SettingCheckboxOption,
  SettingCheckboxGroup} from "~/components/user-panel/setting-checkbox";
  ...
  return (
    <section className="flex gap-x-5 w-full items-start">
        ...
        <form
          ...
          className="flex flex-col gap-2.5 w-full text-subtext-1"
        >
          ...
          <section className="bg-crust rounded-xl flex flex-col w-full">
            <figure className="grid grid-cols-6 grid-rows-1 content-center items-center">
              ...
              <figcaption className="col-start-3 col-end-7 flex flex-col gap-y-2 m-2.5">
                ...
                className="p-2 w-full rounded-md content-center bg-mantle h-13 text-[20px] font-extrabold"/>
          ...
          <section className="flex flex-col gap-y-2.5 bg-crust p-5 rounded-xl">
            ...
            <div className="flex flex-wrap gap-[5px]">
              <MyRadioGroup
                ...
                description="Select one of the color options below."
                options={[
                  {
                    label: "lavender",
