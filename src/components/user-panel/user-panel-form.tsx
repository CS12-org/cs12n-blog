    ...
    <main>
      <form onSubmit={submitHandler} className="text-subtext-1 flex w-full flex-col gap-2.5">
        <header className="flex items-center justify-between">
          ...
          <Button type="submit" className="bg-sapphire text-crust h-[36px] w-[39px] rounded text-sm">
            ثبت
          </Button>
        </header>
                ...
                render={({ field, fieldState }) => (
                  ...
                  >
                    <Input
                      ...
                      className="bg-mantle h-13 w-full rounded-md px-2.5 py-2 text-xl font-extrabold"
                    />
                    <Text
                      slot="description"
