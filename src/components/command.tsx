...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.Separator ref={ref} className={twMerge('bg-border -mx-1 h-px', className)} {...props} />
));
...
const CommandShortcut = ({ className, ...props }: React.HTMLAttributes<HTMLSpanElement>) => {
  return <span className={twMerge('text-muted-foreground ml-auto text-xs tracking-widest', className)} {...props} />;
};
