    ...
    <section className="flex flex-col gap-[10px]">
      <section className="p-[10px] w-full gap-[10px] flex justify-between items-start bg-mantle rounded-[10px]">
        <p className="text-body-sm text-subtext-0 w-full">
          ...
          ۱۵ پست را ذخیره کنید تا بعدا مطالعه کنید. هر پست به مدت ۱۰ روز در لیست
          ذخیره های شما باقی می ماند. و پس از روز ۱۰ ام حذف میشود چرا که اگر
          میخواستید مطالعه کنید طی این ۱۰ روز مطالعه میکردید.
        </p>
