...
function CommentMessege() {
  return (
    <article className=" w-full flex flex-col px-[20px] ">
      <header className="flex justify-between  lg:rounded-tr-full lg:rounded-br-full rounded-tr-[10px] rounded-tl-[10px] p-[10px]  bg-crust">
      ...
      <section className="text-[12px] text-text bg-[#101122] lg:mx-[20px] rounded-b-[10px] p-[10px] gap-y-[15px] flex flex-col ">
        <p>
