      ...
      <section className="flex gap-[10px]">
        ...
        <Text
          className="w-full lg:text-[16px] 
             flex "
        >
          متوجه شدیم. در حال حاضر مایل به اشتراک گذاری هایلایت ها و یادداشت
          هاتون نیستید! اما نگران نباشید میتونید با کلیک بر روی دکمه زیر اشتراک
          گذاری رو از سر بگیرید.
        </Text>
      </section>
