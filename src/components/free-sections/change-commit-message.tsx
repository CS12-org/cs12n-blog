...
function ChangeCommitMessege() {
  return (
    <section className="bg-[#050615] text-text flex gap-[10px] flex-col px-[10px] lg:px-[30px] w-full py-[10px] text-[12px] lg:text-[14px]">
...
<div className="bg-crust rounded-[10px] w-[40px] h-[40px] lg:h-[48px] lg:w-[48px]  flex items-center justify-center">
      ...
      <Text
        className="w-full lg:text-[16px] 
             flex ml-[-10px] font-bold  lg:mr-[10px] self-center"
      >
